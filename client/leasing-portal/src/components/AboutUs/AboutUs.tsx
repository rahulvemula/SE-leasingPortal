    ...
    <>
      ...
      <div className="aboutUsRow">
        <div className="column">
          <div className="card">
            <img
              src="https://avatars.githubusercontent.com/u/98243209?v=4"
              alt="Lahari"
              style={{ width: "100%" }}
            />
        ...
        <div className="column">
          <div className="card">
            <img
              src="https://avatars.githubusercontent.com/u/8132049?v=4"
              alt="Rahul"
              style={{ width: "100%" }}
            />
            <div className="container">
        ...
        <div className="column">
          <div className="card">
            <img
              src="https://avatars.githubusercontent.com/u/34827172?v=4"
              alt="Mitul"
              style={{ width: "100%" }}
            />
            <div className="container">
        ...
        <div className="column">
          <div className="card">
            <img
              src="https://avatars.githubusercontent.com/u/16957347?s=400&u=4da3a5e6d98a8bbc42f3ee4389c43cae1808f2fe&v=4"
              alt="Vamsi"
              style={{ width: "100%" }}
            />
            <div className="container">
